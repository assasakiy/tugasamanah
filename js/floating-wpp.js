(function ($) {
    $.fn.floatingWhatsApp = function (options) {
        ...
        function sendWhatsappMessage() {
            ...
            gtag_report_conversion('https://api.whatsapp.com/send/?phone=6281529538769&text=Halo+min.+Saya+mau+pesan+jasa+ketik');
        }
    }
...
$(function () {
    $('#myButton').floatingWhatsApp({
        phone: '6281529538769',
        popupMessage: 'Tugas Amanah siap membantu Anda. Jika Anda membutuhkan layanan pengetikan rapi dan terjangkau, silakan chat untuk menghubungi Admin',
        message: "Halo min, saya ingin memesan jasa ketik",
        showPopup: true,
        showOnIE: false,
        headerTitle: 'Selamat datang di Tugas Amanah!',
    });  
});